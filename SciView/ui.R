  ...
  tagList(
    ...
    dashboardPage(
      ...
      dashboardBody(
        ...
        shinyDashboardThemes(theme = "poor_mans_flatly"),#"onenote","purple_gradient" poor_mans_flatly
        tabItems(          
    ...
    tags$footer(align="center",
                ...
                #  </div>"),
                tags$p("Copyright (c) 2020; Version 1.02",color="black"), 
                ...
                style = "bottom:0;width:100%;color: #6a51a3;padding: 5px;
